...
<html lang="en">
            ...
            <div class="main-container-inner">
                ...
                <div class="main-content">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="page-header">
                                <h1 class="center">机房列表</h1>
                            </div>
                            <table id="dynamic-table"  class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th class="col-sm-1">序号</th>
                                        <th class="col-sm-1">机房名称</th>
                                        <th class="col-sm-1">公司名称</th>
                                        <th class="col-sm-2">机房地址</th>
                                        <th class="col-sm-1">联系电话</th>
                                        <th class="col-sm-1">联系QQ</th>
                                        <th class="col-sm-1">联系人</th>
                                        <th class="col-sm-1">创建时间</th>
                                        <th class="col-sm-1">机房带宽</th>
                                        <th class="col-sm-1">带宽单价</th>
                                        <th class="col-sm-1">操作</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php if(is_array($houseList)): $i = 0; $__LIST__ = $houseList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        <td><?php echo ($vo["id"]); ?></td>
                                        <td><?php echo ($vo["houname"]); ?></td>
                                        <td><?php echo ($vo["company"]); ?></td>
                                        <td><?php echo ($vo["address"]); ?></td>
                                        <td><?php echo ($vo["telphone"]); ?></td>
                                        <td><?php echo ($vo["linkqq"]); ?></td>
                                        ...
                                        <td>
                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                <a data-rel="tooltip" data-placement="top" houid="<?php echo ($vo["id"]); ?>" data-target="modifyhouse" title="修改" class="green" href="javascript:void(0)">
                                                    <i class="icon-pencil bigger-130"></i>
                                                </a>
                                                <a data-rel="tooltip" data-placement="top" data-target="deleteHouse" url="<?php echo U('Public/deleteHouse');?>" sid="<?php echo ($vo["id"]); ?>" title="删除" class="red" href="javascript:void(0);">
                                                    <i class="icon-trash bigger-130"></i>
                                                </a>
                                                <a data-rel="tooltip" data-placement="top" href="<?php echo U('Public/amendCup',array('houid'=>$vo['id']));?>" title="查看机柜" class="blue" >
    ...
    <div class="modal fade" id="addhouse" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true">
        <div class="modal-dialog" style="width:60%">
             <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close"
                ...
                <div class="modal-body" id="addModifyHouseDiv">
                    <form class="form-horizontal" id="addModifyHouseForm" role="form" action="<?php echo U('Create/addHouseHandle');?>" method="POST">
                        <div class="form-group">
                            <label class="col-sm-2 control-label text-right">机房名称: </label>
                            <div class="col-md-4 form-inner">
                                <input type="text" name="houname" value="" class="col-sm-9">
                                <input type="hidden" name="id"/>
                                <span class="col-sm-3 red">必填</span>
                             </div>
                             <label class="col-sm-2 control-label text-right">公司名称: </label>
                            <div class="col-md-4 form-inner">
                                <input type="text" name="company" value="" class="col-sm-9">
                                <span class="col-sm-3 red">必填</span>
                             </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label text-right">机房地址: </label>
                            <div class="col-md-4 form-inner">
                                <input type="text" name="address" value="" class="col-sm-9">
                                <span class="col-sm-3 red">必填</span>
                             </div>
                             <label class="col-sm-2 control-label text-right">联系人: </label>
                            <div class="col-md-4 form-inner">
                                <input type="text" name="contact" value="" class="col-sm-9">
                             </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label text-right">联系电话: </label>
                            <div class="col-md-4 form-inner">
                                <input type="text" name="telphone" value="" class="col-sm-9">
                             </div>
                             <label class="col-sm-2 control-label text-right">联系QQ: </label>
                            <div class="col-md-4 form-inner">
                                <input type="text" name="linkqq" value="" class="col-sm-9">
                             </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label text-right">机房带宽: </label>
                            <div class="col-md-4 form-inner">
                                <input type="text" name="bandwidth" value="0" class="col-sm-9">
                             </div>
                             <label class="col-sm-2 control-label text-right">带宽价格: </label>
                            <div class="col-md-4 form-inner">
                                <input type="text" name="price" value="0" class="col-sm-9">
                             </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label text-right">所在区域: </label>
                            <div class="col-md-4 form-inner">
                                <select  name="place" class="col-sm-9">
                                    <option value></option>
                                    <?php if(is_array($placeList)): $i = 0; $__LIST__ = $placeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                                <span class="col-sm-3 red">必填</span>
                             </div>
                        </div>
...
$(function(){
    // 增加机房
    $("[data-target=addhouse]").click(function(){
        var form = $("#addModifyHouseForm").get(0);
        form.action = "<?php echo U('Create/addHouseHandle');?>";
        $("#addhouse").modal('show');
    });
    // 删除机房
    $("[data-target=deleteHouse]").click(function(){
        var id = $(this).attr('sid');
        var url = $(this).attr('url');
        if(confirm('确认要删除操作吗?')){
            $.post(url,{id:id},function(ret){
    ...
    // 修改机房
    $("[data-target=modifyhouse]").click(function(){
        var houid = $(this).attr('houid');
        var form = $("#addModifyHouseForm").get(0);
        form.action = "<?php echo U('Public/amendHouseHandle');?>";
        $.post("<?php echo U('Public/getHouseInfo');?>",{id:houid},function(ret){
            if(ret.status == 0){
                $("#noticediv .modal-title").text(ret.data);
                $("#noticediv .modal-body").html(ret.info);
                $("#noticediv").modal('show');
            }else{
                form.houname.value = ret.data.houname;
                form.company.value = ret.data.company;
                form.address.value = ret.data.address;
                form.id.value = houid;
                form.bandwidth.value = ret.data.bandwidth;
                form.price.value = ret.data.price;
                form.place.value = ret.data.place;
                form.telphone.value = ret.data.telphone;
                form.contact.value = ret.data.contact;
                form.linkqq.value = ret.data.linkqq;
                $("#addhouse").modal('show');
            }
    ...
    $(".form-horizontal :submit").click(function(){
        var form = $(".form-horizontal").get(0);
        var message = '';
        var state = true;
        if(form.houname.value.length == 0){
            message += '机房名称不能为空.<br>';
            state = false;
        }
        if(form.company.value.length == 0){
            message += '机房所属公司不能为空.<br>';
            state = false;
        }
        ...
        if(form.place.value.length == 0){
            message += '请选择机房所在区域<br>';
            state = false;
        }
        if(state == false){
            $("#noticediv .modal-title").html("警告");
