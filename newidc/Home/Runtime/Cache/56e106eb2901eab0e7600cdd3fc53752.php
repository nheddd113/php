                ...
                <div class="main-content">
                    ...
                    <div class="page-content">
                        <div class="page-header">
                            <h1>
                                <?php if(isset($housename)): ?><a href="<?php echo U('Search/search',array('houid'=>$map['houid']));?>"><?php echo ($housename); ?></a>
                                <?php else: ?>
                                    搜索<?php endif; ?>
                                <small>
                                    <i class="icon-double-angle-right"></i>
                                    <?php if(isset($cupname)): ?><a href="<?php echo U('Search/search',array('houid'=>$map['houid'],'cupid'=>$map['cupid']));?>"><?php echo ($cupname); ?></a>
                                    <?php else: ?>
                                        所有<?php endif; ?>
                                </small>
                            </h1>
                        ...
                        <div class="row">
                            <table id="dynamic-table"  class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php if(is_array($hostinfo)): $i = 0; $__LIST__ = $hostinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($vo["hostype"]); ?></td>
                                        <td><?php echo ($vo["ishost"]); ?></td>
                                        ...
                                        <td>
                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                ...
                                                <?php if(($vo["ishost"]) == "宿主机"): ?><a data-rel="tooltip" data-placement="top" data-target="showVirHost" url="<?php echo U('Ajax/getVirHost');?>" sid="<?php echo ($vo["id"]); ?>" title="查看虚拟机" class="blue" href="javascript:void(0);">
                                                    <i class="icon-zoom-in bigger-130"></i>
                                                </a><?php endif; ?>
                                                <a data-rel="tooltip" data-placement="top" data-target="deleteHost" url="<?php echo U('Hostinfo/deleteHost');?>" sid="<?php echo ($vo["id"]); ?>" title="删除" class="red" href="javascript:void(0);">
                                                    <i class="icon-trash bigger-130"></i>
                                                </a>
                                            </div>
    ...
    <div class="modal fade" id="noticediv" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true">
        ...
        $(function(){
            ...
            $("#dynamic-table").dataTable({
                ...
                searching: false,
                ajax: {
                    url: "<?php echo U('Search/getHost',$map);?>",
                    // type:"POST",
                    dataSrc: 'data',
                    data: function(d){
                        var params = {}
                        ...
                        $.post(url,{id:id},function(ret){
                            if(ret.status == 0){
                                ...
                                for(var i in ret.data){
                                    ...
                                    '<td> '+
                                        '<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">'+
                                            '<a data-rel="tooltip" data-placement="top" sid="'+ret.data[i].id+'" title="修改" data-target="gotohost" class="green" url="<?php echo U('Hostinfo/hostinfo',array('id'=>''));?>" href="javascript:void(0);">'+
                                                '<i class="icon-pencil bigger-130"></i>'+
                                            '</a>&nbsp;'+
                                            '<a data-rel="tooltip" data-placement="top" data-target="deleteHost" url="<?php echo U('Hostinfo/deleteHost');?>" sid="'+ret.data[i].id+'" title="删除" class="red" href="javascript:void(0);">'+
                                                '<i class="icon-trash bigger-130"></i>'+
                                            '</a>'+
                                        '</div>'+
                                    '</td>'
                ...
                aoColumns: [
                    ...
                    {data: function(d){
                        if(d.mainip.length == 0)
                            ...
                            var html = "<a href='<?php echo U('Hostinfo/hostinfo',array('id'=>__id));?>'>"+d.mainip+"</a>"
                    ...
                    {data: function(d){
                        var managerHost = '<a data-rel="tooltip" data-placement="top" data-target="showVirHost" url="<?php echo U('Ajax/getVirHost');?>" sid="'+d.id+'" title="查看虚拟机" class="blue" href="javascript:void(0);">'+
                                '<i class="icon-zoom-in bigger-130"></i>'+
                            '</a>'
                        ...
                        html += '<a data-rel="tooltip" data-placement="top" data-target="deleteHost" url="<?php echo U('Hostinfo/deleteHost');?>" sid="'+d.id+'" title="删除" class="red" href="javascript:void(0);">'+
                                '<i class="icon-trash bigger-130"></i>'+
                            '</a>'+
                        '</div>';
                        return html;
